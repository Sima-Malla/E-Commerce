          ...
          : data.map((product, index) => {
              return (
                <Link
                  ...
                  className="w-full min-w-[280px] md:min-w-[340px] max-w-[280px] md:max-w-[340px] h-36 bg-white rounded-sm shadow flex"
                >
                  <div className="bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[120px]">
                    <img
                  ...
                  <div className="p-4 grid">
                    ...
                    <button
                      className="text-sm bg-orange-600 hover:bg-orange-700 text-white px-3 py-3 rounded-full"
