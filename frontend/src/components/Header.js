  ...
  return (
    <header className="h-16 shadow-md bg-white fixed w-full z-40">
      <div className=" h-full container mx-auto flex items-center px-4 justify-between">
        <div className="">
          <Link to={"/"}>
            <img src={Logo} width={110} height={100} alt="Company Logo" />
          </Link>
        </div>

        <ul className="flex space-x-6 px-2 py-3 text-gray-700 font-medium">
          <li>
            <Link
              to="/"
              className="px-6 py-2 rounded hover:bg-orange-100 transition duration-200"
            >
              Home
            </Link>
          </li>
